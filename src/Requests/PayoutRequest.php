...
/**
 * A class to build and represent a Till Payments "payout" request.
 *
 * "A Payout credits the customer's account with the given amount".
 *
 * @see https://gateway.tillpayments.com/documentation/apiv3#transaction-request-payout
 */
class PayoutRequest extends BaseRequest
{
    ...
    public function __construct(
        ...
        parent::__construct('POST', 'transaction', 'payout');
