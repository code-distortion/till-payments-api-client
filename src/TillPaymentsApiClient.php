...
//    private string $publicIntegrationKey;
     ...
     * @return void
     */
    public function setHttpRequestLogger($callback): void
    {
     ...
     * @return Response
     */
    public function send($tillRequest): Response
    {
        ...
        try {
            ...
            (($httpResponse2 = $httpResponse) ? $httpResponse2->getBody() : null)->rewind();
